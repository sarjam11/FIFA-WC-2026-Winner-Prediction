...
dc=DixonColes(365).fit(train_raw);print("  Dixon-Coles ✓")
xm=XGBModel(CORE_FEATURES).fit(train_aug,val_aug);print("  XGBoost ✓")
lm=LGBModel(CORE_FEATURES).fit(train_aug,val_aug);print("  LightGBM ✓")
mm=MLPModel(ALL_FEATURES).fit(train_aug);print("  MLP ✓")
